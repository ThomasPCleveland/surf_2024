...
/// \brief Definition of the Single_KID class
//
...
class Single_KID : public G4VUserDetectorConstruction
{
public:
  Single_KID();
  virtual ~Single_KID();
...
private:
  ...
  G4CMPSurfaceProperty *indSurfProp;
  G4CMPSurfaceProperty *capSurfProp;
  G4CMPSurfaceProperty *feedSurfProp;
