...
class Kaplan_QP {
public:
    Kaplan_QP(G4MaterialPropertiesTable* prop, G4int vb = 0);
    virtual ~Kaplan_QP();
    ...
    G4double AbsorbPhonon(Phonon phonon,
...
protected:
    ...
    G4double CalcSubgapAbsorption(Phonon phonon,
...
private:
    ...
    G4double tirProb;		//this variable represents the maximum value for the z component
                            ...
                            //this value can be set manually in Kaplan_QP.cc so that it is not
